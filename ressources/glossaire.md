...
| **Vecteur** | Liste de nombres représentant un token ou un texte dans un espace mathématique. Des tokens au sens proche ont généralement des vecteurs proches. Voir aussi : embedding. |
